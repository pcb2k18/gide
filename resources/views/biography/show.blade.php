...
<head>
    ...
    <style>
        ...
        /* Add the missing content-card class */
        .content-card {
...
<div class="border-b border-gray-100 pb-6 mb-8">
    <div class="flex flex-wrap items-center text-sm text-slate-600 gap-x-6 gap-y-2 mb-3">
        ...
        {{-- Show reviewer info for both reviewed and under_review status --}}
        <div class="flex items-center space-x-2">
    ...
    <div class="flex items-center justify-between">
        ...
        @endif
                        ...
                        {{-- Always display content sections --}}
                        <div class="space-y-12">
                           <!-- Quick Facts - Mobile version -->
                            ...
                            <div class="prose prose-lg max-w-none space-y-12">
                                ...
                                @if(isset($data['trendingFocus']['content']) && !empty(trim(strip_tags($data['trendingFocus']['content']))))
                                ...
                                <!-- Early Life Section -->
                                @if(isset($data['earlyLife']['content']) && !empty(trim(strip_tags($data['earlyLife']['content']))))
                                ...
                                <!-- Career Section -->
                                @if((isset($data['career']['timeline']) && !empty($data['career']['timeline'])) || (isset($data['career']['sections']) && !empty($data['career']['sections'])))
                                    <section id="career">
                                        <div class="content-card">
                                            <h2>{{ $data['career']['title'] ?? 'Karriere' }}</h2>

                                            @if(isset($data['career']['timeline']) && !empty($data['career']['timeline']))
                                            ...
                                            @if(isset($data['career']['sections']) && !empty($data['career']['sections']))
                                ...
                                @if(isset($data['personalLife']['content']) && !empty(trim(strip_tags($data['personalLife']['content']))))
                                ...
                                <!-- Net Worth Section -->
                                @if(isset($data['netWorth']['content']) && !empty(trim(strip_tags($data['netWorth']['content']))))
                                ...
                                <!-- FAQ Section -->
                                @if(isset($data['faqs']['questions']) && !empty($data['faqs']['questions']))
                                    <section id="faqs">
                                        <div class="content-card">
                                ...
                                <!-- Sources Section -->
                                @if(isset($data['sources']['sourceList']) && !empty($data['sources']['sourceList']))
                                    <section id="quellen">
                                        <div class="content-card">
                                            ...
                                            <ol class="space-y-4 text-gray-700 not-prose">
                                                @foreach($data['sources']['sourceList'] as $source)
                                                    @if(is_array($source) && !empty($source['url']) && $source['url'] !== 'Unbekannt')
                                                        <li class="flex bg-gray-50 rounded-lg p-4 hover:bg-gray-100 transition-colors">
                                                            ...
                                                            <div class="flex-1">
                                                                ...
                                                                @if(!empty($source['publisher']) && $source['publisher'] !== 'Unbekannt')<p class="text-slate-600 mt-1 text-sm">Publisher: {{ $source['publisher'] }}</p>@endif
                                                            </div>
                                                        </li>
                                                    @endif
                                                @endforeach
